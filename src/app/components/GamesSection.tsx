...
const GamesSection = () => {
  ...
  const featuredGame: FeaturedGame = {
    ...
    subtitle: 'Course Final Project - Free to Play',
    description: 'Based on the acclaimed movie Tumbbad, this 3-level Android game follows the protagonist as he returns home to rescue his mother from the villain. Developed as a final project for a course in India, showcasing narrative-driven mobile game development.',
  ...
  const otherGames: Game[] = [
    ...
    {
      id: '3d-runner',
      title: '3D Runner (Enhanced Version)',
      description: 'Endless runner game with lane-switching mechanics, coin collection, and obstacle avoidance. Enhanced version developed in both Blueprints and C++ in Unreal Engine 5, showcasing versatile programming skills.',
      role: 'Solo Developer',
      platform: 'PC',
  ...
  const getStatusBadge = (status: string) => {
    const badgeClasses = {
      'Course Final Project': 'bg-green-100 text-green-800 border-green-200',
  ...
  const getPlayButton = (game: Game | FeaturedGame) => {
    switch (game.playLinkStatus) {
      ...
      case 'missing':
        return (
          <button className="bg-gray-100 text-gray-600 px-6 py-3 rounded-lg font-semibent flex items-center gap-2 cursor-not-allowed">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            From course final projects to innovative game jam entries, 
